...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'shreydipakbhaipatel32@gmail.com', // Your Gmail address
        pass: 'izkb cpuu kdyg zvhs' // Your Gmail password or App Password
    }
});
...
const sendStatusUpdateEmail = async (ticket, newStatus) => {
    try {
        const mailOptions = {
            from: 'shreydipakbhaipatel32@gmail.com',
            to: ticket.email,
